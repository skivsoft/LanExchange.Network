...
namespace LanExchange.Network.Models
{
    ...
    public class ServerInfo101 : ServerInfo100
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U4)]
        private readonly SoftwareTypes m_SoftwareType;
        /// <summary>
        ...
        /// <param name="softwareType">Type of the software.</param>
        /// <param name="comment">The comment.</param>
        public ServerInfo101(ServerPlatform platformId, string name, uint versionMajor, uint versionMinor, SoftwareTypes softwareType, string comment) : base(platformId, name)
        {
        ...
        /// </value>
        public SoftwareTypes SoftwareType
        {
            get { return m_SoftwareType; }
        }
